...
// Vendored from 21st.dev: @amanshakya307/cloudscape (MIT).
// A WebGL-powered animated cloud gradient - soft, flowing sky-like background
// from layered noise and colour blending. See DESIGN.md "Hero".
