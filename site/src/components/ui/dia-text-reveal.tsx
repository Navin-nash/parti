...
// Vendored from 21st.dev: @soralabs/dia-text-reveal (MIT).
// Text revealed by a gradient sweep + chromatic wash, optional phrase cycling.
// Pass `colors` to swap the wash to the Proof accent.
